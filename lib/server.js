...
// [React protocol](http://atmosphere.github.io/react/) written in
// easy-to-read JavaScript running on Node.js.
// 
// **Note**
// * For production use, see the React Java Server.
...
// ## API
// `require("react-protocol").server()` creates a react server that is installed
