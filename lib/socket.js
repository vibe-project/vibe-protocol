...
var url = require("url");
var createWebSocketTransport = require("./transport-ws-transport");
...
module.exports = function(uri, options) {
    ...
    // Prepares for `options` object. It contains configuration for not only
    // socket but also transport.
    options = options || {};
    ...
    // nothing if not. By modifying this option, user can replace default
    // transports with customized transports and use their own transports.
