...
module.exports = function(uris, options) {
    ...
    self.open = function() {
        ...
        for (var i = 0; i < uris.length; i++) {
            ...
            // doesn't exist is an abbreviated one. It is translated into ones
            // whose `transport` param is `ws`, `stream` and `longpoll`
            // respectively. For example, if uri is
            ...
            if ((urlObj.protocol === "http:" || urlObj.protocol === "https:") && !urlObj.query.transport) {
                ...
                // `http://localhost:8080/vibe?transport=ws`
