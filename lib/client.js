...
module.exports = function(uri, options) {
    ...
    function open() {
        // Removes the first element and gets it.
        var type = candidates.shift();
        // If it doesn't exist, fires `error` and `close` event as it means that
        // all available transports failed.
        if (!type) {
        ...
        trans = transports[type](uri, {timeout: options.timeout});
