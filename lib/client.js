...
// 
// **Note**
// * For production use, see the Vibe JavaScript Client.
...
// ## API
// `require("vibe-protocol").open` opens a new socket and returns it.
//
...
// ## URI
// An URI is the complete path to the vibe server endpoint. The protocol uses
